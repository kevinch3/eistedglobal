...
$c = $_POST['c'];
$anio = substr("$c", 0, 4); ?>
<a href="competencias.php?a=<?php echo $anio; ?>"><img src="http://www.bajabound.com/images/global/goback.png" alt="volver" width="16" height="16" border="0" align="middle">Volver</a>
</div>

<h1><span></span>Inscripcion a competencia:</h1>
<h2>
...
<li class='field_block' id='field_2_div'><div class='col_label'>
	...
	<div id='field_2_tip' class='instruction'>Pa&iacute;s o Estado Nacional del que proviene</div>
	</div>
</li>
...
?>
	...
	<div id='field_6_tip' class='instruction'>Fecha en la que naci&oacute; (en caso de ser una sola persona)</div>
	</div>
</li>
...
$c = $_POST['c'];
$des = $_POST['des'];
$competencia = substr("$c", -3);

?>
	  <input type="hidden" name="field_11"  id="field_11" value="<?php  phpfmg_hsc("field_11", "$competencia - $des"); ?>" class='text_box'>
      <?php echo $des ; ?>
...
<li class='field_block' id='phpfmg_captcha_div'>C&oacute;digo de seguridad
