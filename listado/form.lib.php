<?php
# PHPFMG_ID:'20120917-2024'
# Date : 20120917 22:15:28
...
define( 'PHPFMG_TO' , 'secretaria@eisteddfod.org.ar' );
define( 'PHPFMG_REDIRECT', '' ); 

define( 'PHPFMG_ID' , '20120917-2024' ); 
...
define( 'PHPFMG_SUBJECT' , "Inscripción entrante" );
define( 'PHPFMG_CC' , 'secretaria@eisteddfod.org.ar, webmaster@eisteddfod.org.ar' );
define( 'PHPFMG_BCC', '' );
...
<!-- [Your confirmation message goes here] -->
    ...
    <b>¡Se ha enviado la Inscripción!
Nos comunicaremos en las próximas 72 horas para confirmar la misma al email que nos brindó.
Muchas gracias!
...
$GLOBALS['form_mail']['field_0'] = array( "name" => "field_0", "text" => "Nombre, Seudonimo, o Denominacion",  "type" => "senderfirstname", "instruction" => "Ingrese su nombre", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_1'] = array( "name" => "field_1", "text" => "Apellido",  "type" => "senderlastname", "instruction" => "Ingrese su apellido (en caso de ser coro, dejar en blanco)", "required" => "" ) ;
$GLOBALS['form_mail']['field_2'] = array( "name" => "field_2", "text" => "Nacionalidad",  "type" => "text", "instruction" => "País o Estado Nacional del que proviene", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_3'] = array( "name" => "field_3", "text" => "Provincia",  "type" => "text", "instruction" => "Provincia o Estado Provincial (intermedio)", "required" => "" ) ;
$GLOBALS['form_mail']['field_4'] = array( "name" => "field_4", "text" => "Ciudad",  "type" => "text", "instruction" => "Ciudad o Municipio al que pertenece", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_5'] = array( "name" => "field_5", "text" => "DNI",  "type" => "text", "instruction" => "Solo en caso de ser una sola persona", "required" => "" ) ;
$GLOBALS['form_mail']['field_6'] = array( "name" => "field_6", "text" => "Fecha de Nacimiento",  "type" => "date", "instruction" => "Fecha en la que nació (en caso de ser una sola persona)", "required" => "" ) ;
phpfmg_date_dropdown_require('field_6');
$GLOBALS['form_mail']['field_7'] = array( "name" => "field_7", "text" => "Section Break Text Goes Here",  "type" => "sectionbreak", "instruction" => "", "required" => "Not Required" ) ;
$GLOBALS['form_mail']['field_8'] = array( "name" => "field_8", "text" => "Telefono de referencia",  "type" => "text", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_9'] = array( "name" => "field_9", "text" => "Email",  "type" => "generic email", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_10'] = array( "name" => "field_10", "text" => "Direccion Postal",  "type" => "text", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_11'] = array( "name" => "field_11", "text" => "Competencia a inscribirse",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_12'] = array( "name" => "field_12", "text" => "Alguna observacion",  "type" => "textarea", "instruction" => "Ingrese solo aquellos datos que considere relevantes", "required" => "" ) ;
...
function phpfmg_header( $title="", $keywords="", $description="" ){
    $t = "Inscripcion Eisteddfod del Chubut";
...
<div align="center" class='form_description'>
