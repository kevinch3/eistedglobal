...
$query_personas = "SELECT * FROM persona WHERE tipo = '$type' ORDER BY Nombre ASC";
...
<table border="0" align="center">
  ...
  <?php do { ?>
    <tr>
      <td width="200"><?php echo "<b>".$row_personas['Nombre']."</b>";?></td>
      <td><?php echo $row_personas['Nacionalidad']; ?></td>
      <td><?php echo $row_personas['Residencia']; ?></td>
      <td width="180"><?php echo $row_personas['Email']; ?></td>
